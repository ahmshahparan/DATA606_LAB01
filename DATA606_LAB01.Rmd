...
From the first histogram we can see, around 16000~17000 respondants want to lose some weight ranging from 0-50 lb. On the other hans, only 1000~2000 respondants want to gain some weight ranging from 0-50 lb.

From the second histogram we can see, around 8000~9000 respondants are very close to have their ideal weights in range of -10~10 lbs weight difference.
